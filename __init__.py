...
from .blueprints import admin, auth, calendar, chat, dashboard, documents, misc, research
...
def create_app():
    ...
    for bp_module in (misc, auth, dashboard, documents, calendar, chat, admin, research):
