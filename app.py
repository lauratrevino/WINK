...
def chat():
    try:
        ...
        instructions = (
            ...
            f"- For an image, use standard markdown ![description](image URL) — only with a "
            f"real URL you found via web_search, never a URL you're guessing at or making up. "
            f"If you don't have a real image URL from search results, don't fabricate one — "
            f"just answer with text instead. "
